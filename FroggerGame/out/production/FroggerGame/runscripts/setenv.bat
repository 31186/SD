...
@Set WORKDRIVE=C
@Set JDK=%WORKDRIVE%:\Program Files\Java\jdk-13.0.1
...
@REM @Set PACKAGE=_05_observer
@REM @Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@REM @Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=FroggerService
@Set CLIENT_CLASS_PREFIX=FroggerClient
